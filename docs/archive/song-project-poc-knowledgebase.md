# Archived Song-Project POC Knowledge Base

This file records reusable proof-of-concept behavior. It is not the active product knowledge base. The active product is defined by root `idea.md` and root `plan.md`.
