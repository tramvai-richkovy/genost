...
export const SESSION_JOB_SCHEMA_VERSION = 1;
...
export const artifactStatusSchema = z.enum(["queued", "generating", "ready", "failed", "canceled", "missing", "archived"]);
...
export const artifactProvenanceSchema = z
  .object({
    ...
    exactPrompt: z.string().nullable().default(null),
    ...
    referenceArtifactId: z.string().nullable().default(null),
    referencePath: z.string().nullable().default(null),
...
export const sessionJobRecordSchema = z.object({
  schemaVersion: z.literal(SESSION_JOB_SCHEMA_VERSION),
  jobId: z.string().min(1),
  operation: z.enum(["musicgen", "text2midi"]),
...
export type SessionJobRecord = z.infer<typeof sessionJobRecordSchema>;
